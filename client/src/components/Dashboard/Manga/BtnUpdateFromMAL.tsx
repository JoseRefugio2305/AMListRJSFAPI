...
import { updateMangaFromMAL } from "../../../services/dashboardMangaServices";
...
export function BtnUpdateFromMAL({
   ...
   const handleUpdateMAL = () => {
      ...
      showToast({
         severity: "info",
         summary: "Info",
         detail: "Actualizando Manga Espere...",
      });
      updateMangaFromMAL(mangaId)
         .then((resp) => {
            if (!resp.is_success) {
               setLoading(false);
            }
            ...
            <ModalBody>
               <div className="text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                     ¿Estás seguro de querer actualizar desde MAL el Manga
