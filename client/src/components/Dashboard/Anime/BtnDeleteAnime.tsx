...
import { deleteAnime } from "../../../services/dashboardAnimeServides";

interface BtnDeleteAnimeProps {
   animeId: string;
   animeTitulo: string;
   callBackDel: <T>(...args: T[]) => void;
}

export function BtnDeleteAnime({
   animeId,
   animeTitulo,
   callBackDel,
}: BtnDeleteAnimeProps) {
   ...
   const handleDelete = () => {
      showToast({
         severity: "warn",
         summary: "Info",
         detail: "Se esta eliminando el Anime Espere.",
      });
      setLoading(true);
      deleteAnime(animeId)
         .then((resp) => {
            ...
            <ModalBody>
               <div className="text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                     ¿Estás seguro de querer eliminar el Anime{" "}
