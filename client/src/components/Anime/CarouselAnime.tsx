...
export const CarouselAnime = memo(
   ({ isEmision, onlyFavs, username, isOwnProfile }: CarouselAnimeProps) => {
      ...
      const AnimeCardTemplate = useCallback(
         (anime: AnimeSchema) => <AnimeCard {...anime} />,
         [],
      );
                  ...
                  {animes.length > 0 ? (
                     animes.length > 2 ? (
                        <Carousel
                           ...
                           numVisible={5}
                           numScroll={5}
                           itemTemplate={AnimeCardTemplate}
                           autoplayInterval={total > 5 ? 10000 : 0}
...
CarouselAnime.displayName = "CarouselAnime";
