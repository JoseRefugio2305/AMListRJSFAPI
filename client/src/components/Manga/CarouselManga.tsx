...
export const CarouselManga = memo(
   ({
      isPublicacion,
      onlyFavs,
      username,
      ...
      const MangaCardTemplate = useCallback(
         (manga: MangaSchema) => <MangaCard {...manga} />,
         [],
      );
                  ...
                  {mangas.length > 0 ? (
                     mangas.length > 2 ? (
                        <Carousel
                           ...
                           numVisible={5}
                           numScroll={5}
                           itemTemplate={MangaCardTemplate}
                           autoplayInterval={total > 5 ? 10000 : 0}
...
CarouselManga.displayName = "CarouselManga";
